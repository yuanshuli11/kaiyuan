...
module.exports = {
    load: function () {
        ...
        console.log("===当 package 被正确加载的时候执行")
    },

    unload: function () {
        // 当 package 被正确卸载的时候执行
        console.log("=== 当 package 被正确卸载的时候执行")
    ...
    messages: {
        'editor:build-finished': function (event, target) {
            ...
            Editor.log("当 messages editor:build-finished时候执行", target.actualPlatform)
            if (target.actualPlatform == "wechatgame") {
                return
            }
