    ...
    onValueChanged(newVar:any,oldVar:any,pathArr:any[]){
        ...
        if(Array.isArray(this.changeEvents)){
            this.changeEvents.forEach(v=>{
                console.log("==changeEvents pathArray",JSON.stringify(pathArr))
                console.log("==changeEvents newVal",JSON.stringify(newVar))
                console.log("==changeEvents oldVal",JSON.stringify(oldVar))
